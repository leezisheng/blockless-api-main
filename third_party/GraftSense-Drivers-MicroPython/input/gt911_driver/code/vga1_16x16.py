...
# 高度为 16 像素
HEIGHT = 16
# 第一个 ASCII 字符的 ASCII 码为 0x20
FIRST = 0x20
# 最后一个 ASCII 字符的 ASCII 码为 0x7f
LAST = 0x7F

# _FONT 是一个字节字符串，其中每个字节代表一个字符的点阵数据
_FONT = (
...
# FONT 是通过将 _FONT 字节字符串转换为内存视图对象 memoryview(_FONT) 创建的
